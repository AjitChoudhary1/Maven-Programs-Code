...
import maven_code1.Amazon_BrokenLinksPage;
import maven_code1.Amazon_HomePage;
import maven_code1.Amazon_LoginPage;
import maven_code1.Amazon_LogoutPage;

public class TC5_LoginTo_Amazon_FindBrokenLinks_LogOut extends Amazon_BaseClass
{
	@Test
	public void LoginToAmazon_FindBrokenLinks_AndLogOut() throws IOException
	{
		...
		Amazon_LoginPage loginpage= new Amazon_LoginPage(driver);
		   ...
		   Amazon_BrokenLinksPage brokenlinks= new Amazon_BrokenLinksPage(driver);
		           brokenlinks.BrokenLinks(driver);

		     Amazon_BrokenLinksPage.verifythelink("url");
